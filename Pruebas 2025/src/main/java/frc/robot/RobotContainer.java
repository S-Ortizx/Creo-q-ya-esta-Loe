...
public class RobotContainer {
  ...
  private void configureBindings() {
    ...
    xController2.a().whileTrue(new Elevator_Levels(elevator,ci, RobotMap.level2,0,0));
    xController2.b().whileTrue(new Elevator_Levels(elevator,ci, RobotMap.level3,0,0));
    xController2.y().whileTrue(new Elevator_Levels(elevator,ci, RobotMap.level4,0,0));
    xController2.x().whileTrue(new Elevator_Levels(elevator,ci, RobotMap.level1,0,0));
