...
public class RobotMap {
    ...
    public static int coralIntake1 = 3;
    public static int coralIntake2 = 10;
    public static double coralspeed = 0.4;
    ////
    ...
    ////
    public static double level1 = 12;
    public static double level2 = 56;
    public static double level3 = 567;
}
